<?php
/*
    Plugin Name: CMS2CMS Connector to WordPress migration
    Plugin URI: http://www.cms2cms.com
    Description: Migrate your website content from Connector to WordPress easily and automatedly in just a few simple steps.
    Version: 3.7.0
    Author: MagneticOne
...
function cms2cms_connector_plugin_init() {
    load_plugin_textdomain( 'cms2cms-connector-migration', false, dirname( plugin_basename( __FILE__ ) ) . '/languages/' );
}
